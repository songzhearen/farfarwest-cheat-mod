...
// BlueprintGeneratedClass BP_Spell_Beam.BP_Spell_Beam_C
// 0x0040 (0x02F0 - 0x02B0)
class ABP_Spell_Beam_C : public AActor
{
public:
	...
	class UNiagaraComponent*                      NS_Cryptic_Beam;                                   // 0x02C0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	class UNiagaraComponent*                      NS_Beam;                                           // 0x02D8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	float                                         damagesPerTick;                                    // 0x02E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

public:
	void ExecuteUbergraph_BP_Spell_Beam(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_Spell_Beam_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Spell_Beam_C")
	}
	static class ABP_Spell_Beam_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Spell_Beam_C>();
	}
};
DUMPER7_ASSERTS_ABP_Spell_Beam_C;
