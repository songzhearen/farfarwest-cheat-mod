...
// BlueprintGeneratedClass BP_Pickable_Nitro.BP_Pickable_Nitro_C
// 0x0040 (0x02F0 - 0x02B0)
class ABP_Pickable_Nitro_C : public AActor
{
public:
	...
	class UStaticMeshComponent*                   SM_KwartMesh;                                      // 0x02D8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          initialSpawn;                                      // 0x02E8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

public:
	void ExecuteUbergraph_BP_Pickable_Nitro(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_Pickable_Nitro_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Pickable_Nitro_C")
	}
	static class ABP_Pickable_Nitro_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Pickable_Nitro_C>();
	}
};
DUMPER7_ASSERTS_ABP_Pickable_Nitro_C;
