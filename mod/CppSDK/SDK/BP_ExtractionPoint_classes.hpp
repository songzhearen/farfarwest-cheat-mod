...
// BlueprintGeneratedClass BP_ExtractionPoint.BP_ExtractionPoint_C
// 0x0018 (0x02C8 - 0x02B0)
class ABP_ExtractionPoint_C final : public AActor
{
public:
...
public:
	void ExecuteUbergraph_BP_ExtractionPoint(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_ExtractionPoint_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_ExtractionPoint_C")
	}
	static class ABP_ExtractionPoint_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_ExtractionPoint_C>();
	}
};
DUMPER7_ASSERTS_ABP_ExtractionPoint_C;
