...
struct BP_Grenade_BottleCrate_C_ExecuteUbergraph_BP_Grenade_BottleCrate final
{
public:
	...
	class ABP_HealingBottle_C*                    CallFunc_FinishSpawningActor_ReturnValue;          // 0x0118(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_Grenade_BottleCrate_C_ExecuteUbergraph_BP_Grenade_BottleCrate;
