...
// BlueprintGeneratedClass BP_RadioactiveBarrel.BP_RadioactiveBarrel_C
// 0x0038 (0x02E8 - 0x02B0)
class ABP_RadioactiveBarrel_C : public AActor
{
public:
	...
	double                                        heal;                                              // 0x02E0(0x0008)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void F_HideHealthBar();
	void F_Activate(int32 Wildcard, double Delay, class AActor* Owner_0);
	void ExecuteUbergraph_BP_RadioactiveBarrel(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("BP_RadioactiveBarrel_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_RadioactiveBarrel_C")
	}
	static class ABP_RadioactiveBarrel_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_RadioactiveBarrel_C>();
	}
};
DUMPER7_ASSERTS_ABP_RadioactiveBarrel_C;
