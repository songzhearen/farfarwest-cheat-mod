...
struct FL_Spell_C_F_SpawnVoodooDollsInRange final
{
public:
	...
	TArray<struct FVector>                        Locations;                                         // 0x0030(0x0010)(Parm, OutParm)
	TArray<struct FVector>                        foundLocations;                                    // 0x0040(0x0010)(Edit, BlueprintVisible)
	...
	TArray<class ABP_DamageArea_C*>               CallFunc_GetAllActorsOfClass_OutActors_1;          // 0x00B0(0x0010)(ReferenceParm)
	...
	class ABP_DamageArea_C*                       CallFunc_Array_Get_Item_1;                         // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_LessEqual_DoubleDouble_ReturnValue_1;     // 0x011C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_FL_Spell_C_F_SpawnVoodooDollsInRange;

// Function FL_Spell.FL_Spell_C.F_GetNearestActorNotBehindWall
// 0x01C0 (0x01C0 - 0x0000)
struct FL_Spell_C_F_GetNearestActorNotBehindWall final
{
public:
	...
	class UObject*                                __WorldContext;                                    // 0x0028(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 nearestActor;                                      // 0x0030(0x0008)(Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<class AActor*>                         Actors;                                            // 0x0038(0x0010)(Edit, BlueprintVisible, DisableEditOnTemplate)
	...
	float                                         CallFunc_FindNearestActor_Distance;                // 0x0090(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_FL_Spell_C_F_GetNearestActorNotBehindWall;
