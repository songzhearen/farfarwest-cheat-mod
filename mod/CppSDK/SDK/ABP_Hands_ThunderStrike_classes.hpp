...
// AnimBlueprintGeneratedClass ABP_Hands_ThunderStrike.ABP_Hands_ThunderStrike_C
// 0x00C0 (0x04B0 - 0x03F0)
class UABP_Hands_ThunderStrike_C final : public UAnimInstance
{
public:
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("ABP_Hands_ThunderStrike_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ABP_Hands_ThunderStrike_C")
	}
	static class UABP_Hands_ThunderStrike_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UABP_Hands_ThunderStrike_C>();
	}
};
DUMPER7_ASSERTS_UABP_Hands_ThunderStrike_C;
