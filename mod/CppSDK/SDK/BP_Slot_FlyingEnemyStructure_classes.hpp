...
// BlueprintGeneratedClass BP_Slot_FlyingEnemyStructure.BP_Slot_FlyingEnemyStructure_C
// 0x0018 (0x02C8 - 0x02B0)
class ABP_Slot_FlyingEnemyStructure_C final : public AActor
{
public:
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_Slot_FlyingEnemyStructure_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Slot_FlyingEnemyStructure_C")
	}
	static class ABP_Slot_FlyingEnemyStructure_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Slot_FlyingEnemyStructure_C>();
	}
};
DUMPER7_ASSERTS_ABP_Slot_FlyingEnemyStructure_C;
