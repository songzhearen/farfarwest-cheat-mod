...
class ABP_GoldOre_C final : public AActor
{
public:
	...
	class UAudioComponent*                        S_MineableKwart;                                   // 0x02C8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         Hits;                                              // 0x02E8(0x0004)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash)
	int32                                         hitsRequired;                                      // 0x02EC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          pickaxePicked;                                     // 0x02F0(0x0001)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash)

public:
	void ExecuteUbergraph_BP_GoldOre(int32 EntryPoint);
	...
	void OnRep_hits();
	void OnRep_pickaxePicked();
	void ReceiveDestroyed();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("BP_GoldOre_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_GoldOre_C")
	}
	static class ABP_GoldOre_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_GoldOre_C>();
	}
};
DUMPER7_ASSERTS_ABP_GoldOre_C;
