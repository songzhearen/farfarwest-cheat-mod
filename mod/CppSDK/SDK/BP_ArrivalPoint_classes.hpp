...
// BlueprintGeneratedClass BP_ArrivalPoint.BP_ArrivalPoint_C
// 0x0018 (0x02C8 - 0x02B0)
class ABP_ArrivalPoint_C final : public AActor
{
public:
...
public:
	void ExecuteUbergraph_BP_ArrivalPoint(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_ArrivalPoint_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_ArrivalPoint_C")
	}
	static class ABP_ArrivalPoint_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_ArrivalPoint_C>();
	}
};
DUMPER7_ASSERTS_ABP_ArrivalPoint_C;
