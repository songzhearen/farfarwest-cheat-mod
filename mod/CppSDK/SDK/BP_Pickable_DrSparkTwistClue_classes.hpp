...
// BlueprintGeneratedClass BP_Pickable_DrSparkTwistClue.BP_Pickable_DrSparkTwistClue_C
// 0x0038 (0x02E8 - 0x02B0)
class ABP_Pickable_DrSparkTwistClue_C final : public AActor
{
public:
	...
	class UStaticMeshComponent*                   SM_Parable;                                        // 0x02D0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
public:
	void ExecuteUbergraph_BP_Pickable_DrSparkTwistClue(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_Pickable_DrSparkTwistClue_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Pickable_DrSparkTwistClue_C")
	}
	static class ABP_Pickable_DrSparkTwistClue_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Pickable_DrSparkTwistClue_C>();
	}
};
DUMPER7_ASSERTS_ABP_Pickable_DrSparkTwistClue_C;
